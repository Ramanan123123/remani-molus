        ...
        if (msg.messageStubType === 32 || msg.messageStubType === 28) {
            ...
            if (gb !== false) {
                ...
                try { pp = await conn.getProfilePicture(msg.messageStubParameters[0]); } catch { pp = await conn.getProfilePicture(); }
                    var ramanansir = await conn.groupMetadata(msg.key.remoteJid)
                await axios.get(pp, {responseType: 'arraybuffer'}).then(async (res) => {
                await conn.sendMessage(msg.key.remoteJid, res.data, MessageType.image, {thumbnail: fs.readFileSync('./image/bye.jpg'),caption:  gb.message.replace('{pp}', '').replace('{gphead}', ramanansir.subject).replace('{gpmaker}', ramanansir.owner).replace('{gpdesc}', ramanansir.desc).replace('{owner}', conn.user.name) }); });                           
            } else if (gb.message.includes('{gif}')) {
                //created by afnanplk
                    var plkpinky = await axios.get(config.GIF_BYE, { responseType: 'arraybuffer' })
                    var ramanansir = await conn.groupMetadata(msg.key.remoteJid)
                await conn.sendMessage(msg.key.remoteJid, Buffer.from(plkpinky.data), MessageType.video, {mimetype: Mimetype.gif, thumbnail: fs.readFileSync('./image/bye.jpg'),caption: gb.message.replace('{gif}', '').replace('{gphead}', ramanansir.subject).replace('{gpmaker}', ramanansir.owner).replace('{gpdesc}', ramanansir.desc).replace('{owner}', conn.user.name) });
            } else {
                   await conn.sendMessage(msg.key.remoteJid,gb.message.replace('{gphead}', ramanansir.subject).replace('{gpmaker}', ramanansir.owner).replace('{gpdesc}', ramanansir.desc).replace('{owner}', conn.user.name), MessageType.text);
              } 
            }//thanks to farhan      
            return;
            ...
            if (gb !== false) {
                ...
                await axios.get(pp, {responseType: 'arraybuffer'}).then(async (res) => {
                    //created by afnanplk
                await conn.sendMessage(msg.key.remoteJid, res.data, MessageType.image, {thumbnail: fs.readFileSync('./image/wel.jpg'),caption:  gb.message.replace('{pp}', '').replace('{gphead}', ramanansir.subject).replace('{gpmaker}', ramanansir.owner).replace('{gpdesc}', ramanansir.desc).replace('{owner}', conn.user.name) }); });                           
            } else if (gb.message.includes('{gif}')) {
                var plkpinky = await axios.get(config.GIF_WEL, { responseType: 'arraybuffer' })
                var ramanansir = await conn.groupMetadata(msg.key.remoteJid)
                await conn.sendMessage(msg.key.remoteJid, Buffer.from(plkpinky.data),MessageType.video, {mimetype: Mimetype.gif,thumbnail: fs.readFileSync('./image/wel.jpg'), caption: gb.message.replace('{gif}', '').replace('{gphead}', ramanansir.subject).replace('{gpmaker}', ramanansir.owner).replace('{gpdesc}', ramanansir.desc).replace('{owner}', conn.user.name) });
            } else {
                var ramanansir = await conn.groupMetadata(msg.key.remoteJid)
                   await conn.sendMessage(msg.key.remoteJid,gb.message.replace('{gphead}', ramanansir.subject).replace('{gpmaker}', ramanansir.owner).replace('{gpdesc}', ramanansir.desc).replace('{owner}', conn.user.name), MessageType.text);
            }
...
*/
                       ...
                       try {
                            ...
                            if (config.LANG == 'TR' || config.LANG == 'AZ') {
                                ...
                                await conn.sendMessage(conn.user.jid, '*~_________~ Ramani᪥ᴍᴡᴏʟ ~______~*' +
